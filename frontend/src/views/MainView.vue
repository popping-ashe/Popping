  ...
  <div class="page-container">
    <div class="page" :class="slideClass">
      <div class="frame" style="z-index: 0">
        ...
        <div class="tutorial-button font-eng" style="margin-right: 6%" @click="[like(), analyticsLike()]" v-if="isLogin && pageid != getshareid && !(favorite_ids.includes(parseInt(this.pageid)))">
        ...
        <div class="tutorial-button font-eng" style="margin-right: 6%" @click="[dislike(), analyticsDislike()]" v-if="isLogin && pageid != getshareid && favorite_ids.includes(parseInt(this.pageid))">
